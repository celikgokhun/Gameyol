package com.trendyol.celik.gokhun.common.remote

import com.trendyol.celik.gokhun.common.resource.Resource
...
object ResourceReactiveExtensions {
    ...
    fun <T : Any> Observable<T>.remote(startWithLoading: Boolean = true): Observable<Resource<T>> {
        ...
        observeOn(AndroidSchedulers.mainThread())
            ...
            .doOnResourceError { error ->
                ...
                if ((error as? RetrofitException)?.formErrors != null && error.formErrors?.isNotEmpty() == true) {
                    onFormErrors(error.formErrors.orEmpty())
                } else {
                    onError(error)
                }
            }
